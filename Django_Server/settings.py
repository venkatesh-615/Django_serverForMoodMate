...
SECRET_KEY = 'django-insecure-7r65y8fg)rlykm*$&h#qq*s30-*ouj8(t^$*b&yozntq(+wm5y'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Update this to match your frontend's URL
    "http://192.168.43.176:3000", 
    "http://127.0.0.1:8000"  # Update this to match your network IP and port
]
...
# Log the Python version for debugging (optional)
